...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO enrollment (STUDID, COURSEID, DATE_ENROLLED) VALUES ('$studentid', '$courseid', '$date_enrolled')";
    ...
    <div class="col-md-4">
        ...
        <div class="card-body bg-secondary text-white rounded-2">
             <div class="card-title text-center p-2">
                <h2 class="fs-3 text-uppercase">Add New Enrollment</h2>
            </div>
        ...
        <form method="post" action="">
            ...
            <div class="mb-3">
                ...
                <input type="email" class="form-control" id="date_enrolled" name="date_enrolled" required>
            </div>
