                ...
                <tbody>
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            echo "<tr>";
                            echo "<td hidden>" . $row["COURSE_ID"] . "</td>";
                            echo "<td>" . $row["COURSE_NAME"] . "</td>";
                            echo "<td>" . $row["COURSEDESC"] . "</td>";
                            echo "<td>
                                    <a href='edit.php?id=" . $row["COURSE_ID"] . "' class='btn btn-primary'>Edit</a>
                                    <a href='delete.php?id=" . $row["COURSE_ID"] . "' class='btn btn-danger'>Delete</a>
                                 </td>";
                            echo "</tr>";
                        }
                    } else {
