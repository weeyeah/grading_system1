...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO tblstudent (FIRSTNAME, LASTNAME, INST_EMAIL) VALUES ('$fname', '$lname', $email')";
        ...
        <div class="card-body bg-secondary text-white rounded-2">
            ...
            <div class="mb-3">
                ...
                <div class="d-grid py-2">
                    <button type="submit" class="btn btn-primary rounded-pill " >ADD INSTRUCTOR</button>
                </div>
